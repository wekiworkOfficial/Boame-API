...
/**
 * @package Article configuration file
 * @author Moorexa Software foundation 
 */

 // this file contains all the basic configuration for Article controller
 return [
    ...
    // set a default model
    'default.model' => Moorexa\Framework\Models\ArticleProcessor::class,
