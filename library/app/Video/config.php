...
/**
 * @package Video configuration file
 * @author Moorexa Software foundation 
 */

 // this file contains all the basic configuration for Video controller
 return [
    ...
    // set a default model
    'default.model' => Moorexa\Framework\Models\VideoProcessor::class,
