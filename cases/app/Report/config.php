...
/**
 * @package Report configuration file
 * @author Moorexa Software foundation 
 */

 // this file contains all the basic configuration for Report controller
 return [
    ...
    // set a default model
    'default.model' => Moorexa\Framework\Report\Models\Cases::class,
