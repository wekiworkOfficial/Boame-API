...
### Static
Contains Report.css and Report.js files and it's only avaliable for Report views. This directory allows us define custom styles and scripts for our views that can also be extended by other controllers at run time.
