...
### Static
Contains Records.css and Records.js files and it's only avaliable for Records views. This directory allows us define custom styles and scripts for our views that can also be extended by other controllers at run time.
