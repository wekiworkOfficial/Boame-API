...
/**
 * @package Account configuration file
 * @author Moorexa Software foundation 
 */

 // this file contains all the basic configuration for Account controller
 return [
    ...
    // set a default model
    'default.model' => Moorexa\Framework\Account\Models\AccountProcessor::class,
