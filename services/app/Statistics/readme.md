# Statistics controller notebook.
...
### Static
Contains Statistics.css and Statistics.js files and it's only avaliable for Statistics views. This directory allows us define custom styles and scripts for our views that can also be extended by other controllers at run time.
