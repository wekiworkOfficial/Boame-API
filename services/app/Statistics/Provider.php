<?php
namespace Moorexa\Framework\Statistics;

use Closure;
use Moorexa\Middlewares\HasRights;
use Lightroom\Packager\Moorexa\Interfaces\ControllerProviderInterface;
/**
 * Statistics Provider. Will be loaded before the Statistics controller
...
class Provider implements ControllerProviderInterface
{
    ...
    {
        HasRights::hasEnoughAccess($next);
    }
