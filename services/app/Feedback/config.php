...
/**
 * @package Feedback configuration file
 * @author Moorexa Software foundation 
 */

 // this file contains all the basic configuration for Feedback controller
 return [
    ...
    // set a default model
    'default.model' => Moorexa\Framework\Feedback\Models\FeedbackProcessor::class,
