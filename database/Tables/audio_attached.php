...
/**
 * @package Database Table Audio_attached
 * @author Amadi ifeanyi <amadiify.com>
 * 
 * This class provides an handler for Database table Audio_attached, it can work with any database system,
...
class Audio_attached
{
    ...
    {
        $schema->increment('audioattachedid');
        $schema->bigint('casesreportedid');
        $schema->text('audio_address');
        $schema->bigint('total_listen');
    ...
    {
        $option->rename('audio_attached'); // rename table
